...
int main(int argc, char **argv)
{
	...
	argv[1] = "detector";
	argv[2] = "recall";
	argv[3] = "G:\\darknet_오리진_TEST\\build\\darknet\\x64\\data\\3rd_PHC_nighttime.data";
	argv[4] = "G:\\darknet_오리진_TEST\\build\\darknet\\x64\\yolov3_8class_full.cfg";
	argv[5] = "G:\\darknet_오리진_TEST\\build\\darknet\\x64\\yolov3_8class_full_15048.weights";
	argv[6] = "G:\\darknet_오리진_TEST\\build\\darknet\\x64\\video_01.avi";
	argc = 7;
#else
	int i;
	for (i = 0; i < argc; ++i) {
